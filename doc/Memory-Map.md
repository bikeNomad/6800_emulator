...
### Default Configuration (Williams System7 Compatible)
...
│  $4000 ┌──────────────────────────────────────┐    │
│        │                                      │    │
│        │  ROM / EPROM (up to 16KB)            │    │
│        │  • Read-only                         │    │
│        │  • Flash-backed                      │    │
│        │  • Program code                      │    │
│        │  • Loaded via USB or copied from ROM │    │
│        │  • Page-based mapping                │    │
│        │                                      │    │
│  $7FF8 │  ┌────────────────────────────────┐  │    │
│        │  │ Interrupt Vectors              │  │    │
...
│        due to A15 not being decoded                │
│                                                    │
│  MC6800 expects vectors at $FFF8-$FFFF, which      │
│  transparently accesses physical $7FF8-$7FFF       │
└────────────────────────────────────────────────────┘
```
...
config rom C000 2000   # 8KB ROM at $C000-$DFFF
