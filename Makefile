# Makefile to build 6800 emulator for BOARD_NED_SYS7
# Produces BOARD_NED_SYS7 .uf2 file in images/ directory
...
clean: clean-images
	rm -rf $(BUILD_NED_SYS7_DIR) build
...
help:
	...
	@echo "  all          - Build for BOARD_NED_SYS7 (default)"
	@echo "  build_ned_sys7 - Build for BOARD_NED_SYS7"
	...
	@echo "                         Use: make SYS_CLOCK_MHZ=250"
